"""Residual Encoder-Decoder Architecture
https://github.com/JindongJiang/RedNet
https://github.com/kawori/Noise2Noise_PyTorch
"""
...
class RedNet(nn.Module):
    def __init__(self, in_channels=3):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(in_channels, 128, 3, padding=1),
                                   nn.ReLU())
        self.conv2 = nn.Sequential(nn.Conv2d(128, 128, 3, padding=1),
                                   nn.ReLU())
        self.deconv1 = nn.Sequential(nn.ConvTranspose2d(128, 128, 3,
                                     padding=1), nn.ReLU())
