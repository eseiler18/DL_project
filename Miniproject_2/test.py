...
if __name__ == '__main__':
    ...
    project_path = Path("D:\Emilien\Documents\Cours\MA2\DeepLearning\Project\git\DL_project")
    data_path = Path("D:\Emilien\Documents\Cours\MA2\DeepLearning\Project\DL_project\data")
